...
require('./custom/link_on_click.js');
require('./custom/next_environment.js');
require('./custom/set_texture.js');
require('./custom/deactivate_after_delay.js');
require('./custom/move_away_and_back.js');
