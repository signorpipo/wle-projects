...
PP.EasyTextColor = class EasyTextColor extends PP.EasyObjectTuner {
    ...
    _updateObjectValue(object, value) {
        ...
        if ((PP.myRightGamepad.getButtonInfo(PP.GamepadButtonType.TOP_BUTTON).isPressStart() && PP.myLeftGamepad.getButtonInfo(PP.GamepadButtonType.TOP_BUTTON).myIsPressed) ||
            (PP.myLeftGamepad.getButtonInfo(PP.GamepadButtonType.TOP_BUTTON).isPressStart() && PP.myRightGamepad.getButtonInfo(PP.GamepadButtonType.TOP_BUTTON).myIsPressed)) {
